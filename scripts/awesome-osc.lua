...
-- fork by qiyue0726
-- https://github.com/Qiyue0726/awesome-osc
...
local user_opts = {
    ...
    volumecontrol = true,       -- show volumne slider
    keyboardnavigation = false, -- enable directional keyboard navigation
    chapter_fmt = "Chapter: %s", -- chapter print format for seekbar-hover. "no" to disable
    leftBtnArea = {'info','audio','sub','volume','volumeSlider'},
...
function build_keyboard_controls()
    ...
    for key,value in pairs(type(user_opts.leftBtnArea)=='table' and user_opts.leftBtnArea or stringToTable(user_opts.leftBtnArea)) do
        if value == 'info' then
        ...
        elseif value == 'jumpback' then
            table.insert(bottom_button_line, 'jumpback')
        elseif value == 'backward' then
            table.insert(bottom_button_line, 'backward')
        elseif value == 'prev' then
            table.insert(bottom_button_line, 'pl_prev')
        elseif value == 'backwardAndPrev' then
            table.insert(bottom_button_line, 'backwardAndPrev')
        elseif value == 'jumpfrwd' then
            table.insert(bottom_button_line, 'jumpfrwd')
        elseif value == 'forward' then
            table.insert(bottom_button_line, 'forward')
        elseif value == 'next' then
            table.insert(bottom_button_line, 'next')
        elseif value == 'forwardAndNext' then
            table.insert(bottom_button_line, 'forwardAndNext')
        end
    end

    for key,value in pairs(type(user_opts.centerBtnAreaL)=='table' and user_opts.centerBtnAreaL or stringToTable(user_opts.centerBtnAreaL)) do
        if value == 'jumpback' then
            table.insert(bottom_button_line, 'jumpback')
        elseif value == 'backward' then
            table.insert(bottom_button_line, 'backward')
        elseif value == 'prev' then
    ...
    for key,value in pairs(type(user_opts.centerBtnAreaR)=='table' and user_opts.centerBtnAreaR or stringToTable(user_opts.centerBtnAreaR)) do
        if value == 'jumpfrwd' then
            table.insert(bottom_button_line, 'jumpfrwd')
        elseif value == 'forward' then
            table.insert(bottom_button_line, 'forward')
        elseif value == 'next' then
    ...
    for key,value in pairs(type(user_opts.centerBtnArea)=='table' and user_opts.rightBtnArea or stringToTable(user_opts.rightBtnArea)) do
        if value == 'info' then
            table.insert(bottom_button_line, 'tog_info')
        elseif value == 'audio' then
            table.insert(bottom_button_line, 'cy_audio')
...
layouts = function ()
    ...
    local centerOffsetL = 60
    local centerOffsetR = 60
    if inTable(user_opts.leftBtnArea,'play') then
    else
    ...
    for key,value in pairs(type(user_opts.centerBtnAreaL)=='table' and user_opts.centerBtnAreaL or stringToTable(user_opts.centerBtnAreaL)) do
        if value == 'jumpback' then
            ...
            lo.geometry = {x = refX - centerOffsetL, y = refY - 40 , an = 5, w = 30, h = 24}
            lo.style = osc_styles.Ctrl2
            centerOffsetL = centerOffsetL + 50
        elseif value == 'backward' then
            lo = add_layout('backward')
            lo.geometry = {x = refX - centerOffsetL, y = refY - 40 , an = 5, w = 30, h = 24}
            lo.style = osc_styles.Ctrl2
            centerOffsetL = centerOffsetL + 50
        elseif value == 'prev' then
    ...
    for key,value in pairs(type(user_opts.centerBtnAreaR)=='table' and user_opts.centerBtnAreaR or stringToTable(user_opts.centerBtnAreaR)) do
        if value == 'jumpfrwd' then
            ...
            lo.geometry = {x = refX + centerOffsetR, y = refY - 40 , an = 5, w = 30, h = 24}
            lo.style = osc_styles.Ctrl2
            centerOffsetR = centerOffsetR + 50
        elseif value == 'forward' then
            lo = add_layout('forward')
            lo.geometry = {x = refX + centerOffsetR, y = refY - 40 , an = 5, w = 30, h = 24}
            lo.style = osc_styles.Ctrl2
            centerOffsetR = centerOffsetR + 50
        elseif value == 'next' then
    ...
    for key,value in pairs(type(user_opts.leftBtnArea)=='table' and user_opts.leftBtnArea or stringToTable(user_opts.leftBtnArea)) do
        if value == 'play' then
            lo = add_layout('playpause')
            lo.geometry = {x = leftOffset, y = refY - 40 , an = 5, w = 45, h = 45}
            lo.style = osc_styles.Ctrl1
            leftOffset = leftOffset + 50
        elseif value == 'jumpback' then
            lo = add_layout('jumpback')
            lo.geometry = {x = leftOffset, y = refY - 40 , an = 5, w = 30, h = 24}
            lo.style = osc_styles.Ctrl2
            leftOffset = leftOffset + 50
        elseif value == 'backward' then
            lo = add_layout('backward')
        ...
        elseif value == 'volume' then
            ...
            leftOffset = leftOffset + 50
        elseif value == 'volumeSlider' then
            lo = new_element('volumebarbg', 'box')
            lo.visible = (osc_param.playresx >= 750) and user_opts.volumecontrol
            lo = add_layout('volumebarbg')
            lo.geometry = {x = leftOffset - 30, y = refY - 40, an = 4, w = 80, h = 2}
            lo.layer = 13
            lo.style = osc_styles.VolumebarBg

            lo = add_layout('volumebar')
            lo.geometry = {x = leftOffset - 30, y = refY - 40, an = 4, w = 80, h = 8}
    ...
    for key,value in pairs(type(user_opts.rightBtnArea)=='table' and user_opts.rightBtnArea or stringToTable(user_opts.rightBtnArea)) do
        if value == 'info' then
            lo = add_layout('tog_info')
        ...
        elseif value == 'volumeSlider' then
            ...
            lo.visible = (osc_param.playresx >= 750) and user_opts.volumecontrol
            lo = add_layout('volumebarbg')
            lo.geometry = {x = osc_geo.w - rightOffset - 60, y = refY - 40, an = 4, w = 80, h = 2}
            lo.layer = 13
            lo.style = osc_styles.VolumebarBg

            lo = add_layout('volumebar')
            lo.geometry = {x = osc_geo.w - rightOffset - 60, y = refY - 40, an = 4, w = 80, h = 8}
            lo.style = osc_styles.VolumebarFg
            lo.slider.gap = 3
            lo.slider.tooltip_style = osc_styles.Tooltip
            lo.slider.tooltip_an = 2
...
function osc_init()
    ...
    new_element_ctrlBtn(ne,user_opts.leftBtnArea)
    new_element_ctrlBtn(ne,user_opts.centerBtnAreaL)
    new_element_ctrlBtn(ne,user_opts.centerBtnAreaR)
    ...
    ne.visible = (osc_param.playresx >= 650)
    ne.content = function ()
        if (state.mute) then
...
function new_element_ctrlBtn(ne,table)
    ...
    for key,value in pairs(type(table)=='table' and table or stringToTable(table)) do
        ...
        elseif value == 'backward' then
            --backward
            ne = new_element('backward', 'button')
        ...
        elseif value == 'backwardAndPrev' then
            --backwardAndPrev
            ne = new_element('backwardAndPrev', 'button')
            ne.content = icons.backwardAndPrev
            ne.eventresponder['mbtn_left_down'] =
                function () mp.commandv('seek', -user_opts.jumpamount, user_opts.jumpmode) end
            ne.eventresponder['shift+mbtn_left_down'] =
                function () mp.commandv("add", "chapter", -1) end
            ne.eventresponder['mbtn_right_down'] =
        ...
        elseif value == 'forwardAndNext' then
            --forwardAndNext
            ne = new_element('forwardAndNext', 'button')
            ne.content = icons.forwardAndNext
            ne.eventresponder['mbtn_left_down'] =
                function () mp.commandv('seek', user_opts.jumpamount, user_opts.jumpmode) end
            ne.eventresponder['shift+mbtn_left_down'] =
                function () mp.commandv("add", "chapter", 1) end
